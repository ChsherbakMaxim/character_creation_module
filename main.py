...
def special(char_name: str, char_class: str) -> str:
    """Will return the value of a special skill."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Teaches basic character functions."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Will return the selected player class."""
    approve_choice: str = ''
    char_class: str = ''
...
def main():
    """Will launch the welcome screen and run the code."""
